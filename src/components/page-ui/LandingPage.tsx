...
export function LandingPage() {
    return (
        ...
        >
            ...
            <p className="text-xs text-neutral-600 dark:text-neutral-200 sm:text-base  "> Hello, I&apos;m Sushant. A passionate Software Engineer.</p>
            <TypewriterEffectSmooth words={words} />
            <div className="z-30 flex flex-col items-center space-x-0 space-y-4 md:flex-row md:space-x-4 md:space-y-0">
                <Link href="https://drive.google.com/file/d/1DR79gxaTd9jqMgGNdOtuLCPsnCs2IL61/view?usp=sharing">
